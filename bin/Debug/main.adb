...
S:Lmain.aligned_alloc$size$1_0$119({2}SI:U),B,1,-2
S:Lmain.aligned_alloc$alignment$1_0$119({2}SI:U),B,1,-4
F:G$main$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:Lmain.main$damageFlag$2_1$133({1}SC:S),R,0,0,[a]
S:Lmain.main$sloc0$0_1$0({2}DG,SC:U),B,1,-2
...
S:G$HeroExec$0_0$0({2}DF,SV:S),C,0,0
...
S:G$doukutsuInit$1_0$131({2}DF,SI:S),C,0,0
S:G$StartBlink$3_1$134({2}DF,SI:S),C,0,0
S:G$BlinkExec$2_1$133({2}DF,SI:S),C,0,0
